...
- **PENDING (USER, balance):** `StartingLives` **3 / 15 / 10** across Acts 1–3 — Act 1's `3` looks like a leftover test value. **B58 EVIDENCE:** seeding Stage1_Act1 with EIGHT level-20 towers cleared 12 of 15 waves for 66,850 damage and STILL lost on lives; it took 24 towers at max meta / max ascension / perfect rolls to hold 15/15. A clear that strong losing to 3 lives is the strongest sign yet that the `3` is a test value.
